...
<head>
	...
	<!--[if IE]>
    <link href="${path.to.css}/ie.css" rel="stylesheet" type="text/css"> <![endif]-->

	<script type="text/javascript" src="${online.jquery-script}"></script>
	<script type="text/javascript" src="${online.jquery.ui-script}"></script>
			...
			<div id="tab-container" class="tab-container">
							...
							<li class="currentFile">
								<div class="fileProcess">
									...
									<div class="contentProgress">
										<div class="barG tipN" title="61%" id="bar10"></div>
									</div>
								</div>
							</li>
				...
				<div id="alt1">
					...
					<div class="sideWidget">
						<div class="contentProgress">
							<div class="barGr tipS" id="bar1" title="15%"></div>
						</div>
						<div class="contentProgress mt8">
							<div class="barB tipS" id="bar2" title="30%"></div>
						</div>
						<div class="contentProgress mt8">
							<div class="barO tipS" id="bar3" title="45%"></div>
						</div>
						<div class="contentProgress mt8">
							<div class="barBl tipS" id="bar4" title="60%"></div>
						</div>
						<div class="contentProgress mt8">
							<div class="barR tipS" id="bar5" title="75%"></div>
						</div>
					</div>
	...
	<div class="wrapper">
				...
				<ul class="messagesOne">
					<li class="by_user">
						...
						<div class="messageArea">
							...
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vel est enim, vel eleifend felis. Ut volutpat, leo eget euismod scelerisque, eros purus
							lacinia velit, nec rhoncus mi dui eleifend orci.
		...
		<div class="fluid">
			...
			<div class="grid6">
				...
				<div class="widget">
					<div class="whead"><h6>WYSIWYG editor</h6></div>
