...
import selenium.boot.utils.dates.fluent.FluentDate;
...
import static selenium.boot.hamcrest.date.utils.TimeZones.CET_AS_TZ;
import static selenium.boot.hamcrest.date.utils.TimeZones.EST_AS_TZ;
import static selenium.boot.hamcrest.date.utils.TimeZones.GMT_AS_TZ;
import static selenium.boot.hamcrest.date.utils.TimeZones.PST_AS_TZ;
import static selenium.boot.hamcrest.date.utils.TimeZones.UTC_AS_TZ;
import static selenium.boot.utils.dates.fluent.FluentDateTime.APR;
import static selenium.boot.utils.dates.fluent.FluentDateTime.AUG;
import static selenium.boot.utils.dates.fluent.FluentDateTime.DEC;
import static selenium.boot.utils.dates.fluent.FluentDateTime.FEB;
import static selenium.boot.utils.dates.fluent.FluentDateTime.JAN;
import static selenium.boot.utils.dates.fluent.FluentDateTime.JUL;
import static selenium.boot.utils.dates.fluent.FluentDateTime.JUN;
import static selenium.boot.utils.dates.fluent.FluentDateTime.MAR;
import static selenium.boot.utils.dates.fluent.FluentDateTime.MAY;
import static selenium.boot.utils.dates.fluent.FluentDateTime.NOV;
import static selenium.boot.utils.dates.fluent.FluentDateTime.OCT;
import static selenium.boot.utils.dates.fluent.FluentDateTime.SEP;
...
public abstract class Dates
{
    ...
    public static final Date JUN_15_2012_AS_DATE =  new GregorianCalendar( 2012, Calendar.JUNE, 15 ).getTime();
