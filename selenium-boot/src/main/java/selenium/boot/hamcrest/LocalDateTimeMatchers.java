...
/**
 * Static factory for creating {@link org.hamcrest.Matcher} instances for comparing {@link java.time.LocalDateTime} instances
 *
...
public class LocalDateTimeMatchers
{
    ...
    public static Matcher<LocalDateTime> before( final int year,
                                                 ...
                                                 final int second )
    {
        return new IsBefore<>( new LocalDateTimeWrapper( year,
                                                         month,
                                                         dayOfMonth,
                                                         hour,
                                                         minute,
