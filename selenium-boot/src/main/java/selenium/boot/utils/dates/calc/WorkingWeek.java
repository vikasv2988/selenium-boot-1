...
public class WorkingWeek
{
    ...
    private static final Logger log = LoggerFactory.getLogger( WorkingWeek.class );
    ...
    {
        return isWorkingDay( CalculatorUtil.getCal( date ) );
    }
     ...
     * @param dayOfWeek e.g. Calendar.MONDAY, Calendar.TUESDAY, etc
     *
